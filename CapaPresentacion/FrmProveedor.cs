...
namespace CapaPresentacion
{
    public partial class FrmProveedor : Form
    {
        ...
        private void Limpiar()
        {
            ...
            this.txtCuitcuil.Text = string.Empty;
         ...
         private void Habilitar(bool valor)
        {
            ...
            this.txtCuitcuil.ReadOnly = !valor;
        ...
        private void BuscarRazon()
        {
            this.dataListado.DataSource = NProveedor.BuscarRazon(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }

        private void BuscarCuitcuil()
        {
            this.dataListado.DataSource = NProveedor.BuscarCuitcuil(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                string rpta = "";
                string rpta1 = "";
                if (this.txtRazon.Text == string.Empty || this.txtSector.Text == string.Empty || this.txtCuitcuil.Text == string.Empty ||
                    ...
                    this.txtCalle.Text == string.Empty || this.txtNumero.Text == string.Empty)
                {
                    ...
                    errorIcono.SetError(txtSector, "Ingrese Sector Comercial");
                    errorIcono.SetError(txtCuitcuil, "Ingrese CUIT/CUIL");
                ...
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        ...
                        rpta = NProveedor.Insertar(this.txtRazon.Text.Trim().ToUpper(), this.txtSector.Text.Trim().ToUpper(), 
                            this.txtCuitcuil.Text, this.txtTelefono.Text, this.txtEmail.Text, Convert.ToInt32(this.txtIddomicilio.Text));
                    }
                    else
                    {
                        ...
                        rpta = NProveedor.Editar(Convert.ToInt32(this.txtIdproveedor.Text), this.txtRazon.Text.Trim().ToUpper(), this.txtSector.Text.Trim().ToUpper(),
                            this.txtCuitcuil.Text, this.txtTelefono.Text, this.txtEmail.Text, Convert.ToInt32(this.txtIddomicilio.Text));
                    }
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.txtRazon.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["razonsocial"].Value);
            this.txtSector.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["sectorcomercial"].Value);
            this.txtCuitcuil.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["cuitcuil"].Value);
